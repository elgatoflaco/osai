...
let allModelDefinitions: [ModelDefinition] = [
    ...
    // MARK: Google (direct — uses your Google AI API key)
    ModelDefinition(id: "google/gemini-3.1-pro-preview", displayName: "Gemini 3.1 Pro", shortName: "Gemini 3.1 Pro", provider: "Google", providerKey: "google", tag: "Latest", icon: "sparkles"),
    ModelDefinition(id: "google/gemini-3.1-flash-lite-preview", displayName: "Gemini 3.1 Flash Lite", shortName: "3.1 Flash Lite", provider: "Google", providerKey: "google", tag: "Cheap", icon: "leaf"),
    ModelDefinition(id: "google/gemini-3-pro-preview", displayName: "Gemini 3 Pro", shortName: "Gemini 3 Pro", provider: "Google", providerKey: "google", tag: "Smart", icon: "brain.head.profile"),
    ...
    ModelDefinition(id: "google/gemini-2.5-flash-lite", displayName: "Gemini 2.5 Flash Lite", shortName: "Flash Lite", provider: "Google", providerKey: "google", tag: "Cheap", icon: "leaf"),
    ModelDefinition(id: "google/gemini-2.0-flash", displayName: "Gemini 2.0 Flash", shortName: "Gemini 2.0", provider: "Google", providerKey: "google", tag: "Fast", icon: "bolt"),
